...
const Client2Page = () => {
  ...
  const getCardIcon = (cardLabel) => {
    ...
    const iconMap = {
      ...
      'ASSETS': `${baseUrl}desktop-icons/Balance.svg`,
      'BALANCE': `${baseUrl}desktop-icons/Balance.svg`,
      'BLOCKED COMMISSION': `${baseUrl}desktop-icons/Blocked commision.svg`,
      'BLOCKED PROFIT': `${baseUrl}desktop-icons/Floating PNL.svg`,
      'COMMISSION': `${baseUrl}desktop-icons/AVAILABLE Commision.svg`,
      'THIS WEEK COMMISSION': `${baseUrl}desktop-icons/AVAILABLE Commision.svg`,
      'THIS MONTH COMMISSION': `${baseUrl}desktop-icons/AVAILABLE Commision.svg`,
      'LIFETIME COMMISSION': `${baseUrl}desktop-icons/AVAILABLE Commision.svg`,
      'CREDIT': `${baseUrl}desktop-icons/Credit.svg`,
      'DAILY BONUS IN': `${baseUrl}desktop-icons/Daily BONUS IN.svg`,
      'DAILY BONUS OUT': `${baseUrl}desktop-icons/Daily BONUS OUT.svg`,
      'DAILY CREDIT IN': `${baseUrl}desktop-icons/LIFETIME CREDIT IN.svg`,
      'DAILY CREDIT OUT': `${baseUrl}desktop-icons/LIFETIME CREDIT OUT.svg`,
      'DAILY DEPOSIT': `${baseUrl}desktop-icons/Daily Deposite.svg`,
      'DAILY P&L': `${baseUrl}desktop-icons/P&L.svg`,
      'DAILY SO COMPENSATION IN': `${baseUrl}desktop-icons/Daily BONUS IN.svg`,
      'DAILY SO COMPENSATION OUT': `${baseUrl}desktop-icons/Daily BONUS OUT.svg`,
      'DAILY WITHDRAWAL': `${baseUrl}desktop-icons/Daily WITHDRAWL.svg`,
      'DAILY NET D/W': `${baseUrl}desktop-icons/NET WD.svg`,
      'NET DAILY BONUS': `${baseUrl}desktop-icons/Net Daily Bonus.svg`,
      'EQUITY': `${baseUrl}desktop-icons/Equity.svg`,
      'FLOATING P/L': `${baseUrl}desktop-icons/Floating PNL.svg`,
      'FLOATING PNL': `${baseUrl}desktop-icons/Floating PNL.svg`,
      'FLOATING': `${baseUrl}desktop-icons/Floating PNL.svg`,
      'LIABILITIES': `${baseUrl}desktop-icons/Balance.svg`,
      ...
      'LIFETIME P&L': `${baseUrl}desktop-icons/LIFETIME PNL.svg`,
      'LIFETIME PNL': `${baseUrl}desktop-icons/LIFETIME PNL.svg`,
      'LIFETIME SO COMPENSATION IN': `${baseUrl}desktop-icons/LIFETIME BONUS IN.svg`,
      'LIFETIME SO COMPENSATION OUT': `${baseUrl}desktop-icons/LIFETIME BONUS OUT.svg`,
      'LIFETIME WITHDRAWAL': `${baseUrl}desktop-icons/Daily WITHDRAWL.svg`,
      'NET LIFETIME DW': `${baseUrl}desktop-icons/NET WD.svg`,
      'MARGIN': `${baseUrl}desktop-icons/Balance.svg`,
      'MARGIN FREE': `${baseUrl}desktop-icons/Balance.svg`,
      'THIS MONTH BONUS IN': `${baseUrl}desktop-icons/MONTHLY BONUS IN.svg`,
      'THIS MONTH BONUS OUT': `${baseUrl}desktop-icons/MONTHLY BONUS OUt.svg`,
      'THIS MONTH CREDIT IN': `${baseUrl}desktop-icons/MONTHLY CREDIT IN.svg`,
      'THIS MONTH CREDIT OUT': `${baseUrl}desktop-icons/MOnthly CREDIT OUT.svg`,
      'THIS MONTH DEPOSIT': `${baseUrl}desktop-icons/MONTLY DEPOSITE.svg`,
      'THIS MONTH P&L': `${baseUrl}desktop-icons/THIS MONTH PNL.svg`,
      'THIS MONTH PNL': `${baseUrl}desktop-icons/THIS MONTH PNL.svg`,
      'THIS MONTH SO COMPENSATION IN': `${baseUrl}desktop-icons/MONTHLY BONUS IN.svg`,
      'THIS MONTH SO COMPENSATION OUT': `${baseUrl}desktop-icons/MONTHLY BONUS OUt.svg`,
      'THIS MONTH WITHDRAWAL': `${baseUrl}desktop-icons/MONTLY WITHDRAWL.svg`,
      // Correction and Swap (no dedicated icons; using generic ones)
      'THIS WEEK CORRECTION': `${baseUrl}desktop-icons/Balance.svg`,
      'THIS MONTH CORRECTION': `${baseUrl}desktop-icons/Balance.svg`,
      'LIFETIME CORRECTION': `${baseUrl}desktop-icons/Balance.svg`,
      'THIS WEEK SWAP': `${baseUrl}desktop-icons/P&L.svg`,
      'THIS MONTH SWAP': `${baseUrl}desktop-icons/P&L.svg`,
      'LIFETIME SWAP': `${baseUrl}desktop-icons/P&L.svg`,
      'NET MONTHLY BONUS': `${baseUrl}desktop-icons/NET MONTHLY BONUS.svg`,
      'NET MONTHLY DW': `${baseUrl}desktop-icons/NET MONTHLY DW.svg`,
      'PROFIT': `${baseUrl}desktop-icons/Floating PNL.svg`,
      'STORAGE': `${baseUrl}desktop-icons/Balance.svg`,
      'THIS WEEK BONUS IN': `${baseUrl}desktop-icons/Weekly bonus in.svg`,
      'THIS WEEK BONUS OUT': `${baseUrl}desktop-icons/WEEK BONUS OUT.svg`,
      'THIS WEEK CREDIT IN': `${baseUrl}desktop-icons/WEEKLY Credit IN.svg`,
      'THIS WEEK CREDIT OUT': `${baseUrl}desktop-icons/WEEKLY CREDIT OUT.svg`,
      'THIS WEEK DEPOSIT': `${baseUrl}desktop-icons/WEEK DEPOSITE.svg`,
      'THIS WEEK P&L': `${baseUrl}desktop-icons/This week pnl.svg`,
      'THIS WEEK PNL': `${baseUrl}desktop-icons/This week pnl.svg`,
      'THIS WEEK SO COMPENSATION IN': `${baseUrl}desktop-icons/Weekly bonus in.svg`,
      'THIS WEEK SO COMPENSATION OUT': `${baseUrl}desktop-icons/WEEK BONUS OUT.svg`,
      'THIS WEEK WITHDRAWAL': `${baseUrl}desktop-icons/WEEK WITHDRAWL.svg`,
      'NET WEEK BONUS': `${baseUrl}desktop-icons/NET WEEK BONUS.svg`,
      'NET WEEK DW': `${baseUrl}desktop-icons/NET WEEK DAY.svg`,
      'NET LIFETIME BONUS': `${baseUrl}desktop-icons/LIFETIME BONUS IN.svg`,
      'NET CREDIT': `${baseUrl}desktop-icons/Credit.svg`,
      'BOOK PNL': `${baseUrl}desktop-icons/P&L.svg`,
      'BOOK P&L': `${baseUrl}desktop-icons/P&L.svg`,
      'AVAILABLE REBATE': `${baseUrl}desktop-icons/AVAILABLE Commision.svg`,
      'TOTAL REBATE': `${baseUrl}desktop-icons/TOTAL COMMISION.svg`,
      'NET LIFETIME PNL': `${baseUrl}desktop-icons/LIFETIME PNL.svg`,
      'P&L': `${baseUrl}desktop-icons/P&L.svg`,
      'PNL': `${baseUrl}desktop-icons/P&L.svg`,
      // Percentage variants
      'AVAILABLE REBATE %': `${baseUrl}desktop-icons/AVAILABLE Commision%25.svg`,
      'TOTAL REBATE %': `${baseUrl}desktop-icons/TOTAL COMMISION%25.svg`,
      'NET LIFETIME PNL %': `${baseUrl}desktop-icons/LIFETIME PNL.svg`,
      'BOOK PNL %': `${baseUrl}desktop-icons/P&L.svg`,
      'BOOK P&L %': `${baseUrl}desktop-icons/P&L.svg`,
      'DAILY DEPOSIT %': `${baseUrl}desktop-icons/Daily Deposite.svg`,
    ...
    return iconMap[normalizedLabel] || `${baseUrl}desktop-icons/Clients.svg`
  }
