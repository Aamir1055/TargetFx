...
export default function Client2Module() {
  ...
  const getCardIcon = (cardLabel) => {
    ...
    const iconMap = {
      ...
      'Total Rebate': `${baseUrl}mobile-icons/AVAILABLE Commission.svg`,
      ...
      'Commission': `${baseUrl}mobile-icons/AVAILABLE Commission.svg`,
      ...
      'This Week Commission': `${baseUrl}mobile-icons/AVAILABLE Commission.svg`,
      'This Month Commission': `${baseUrl}mobile-icons/AVAILABLE Commission.svg`,
      'Lifetime Commission': `${baseUrl}mobile-icons/AVAILABLE Commission.svg`,
